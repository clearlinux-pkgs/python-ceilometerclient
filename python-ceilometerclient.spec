...
Version  : 1.0.14
Release  : 11
URL      : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-1.0.14.tar.gz
Source0  : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-1.0.14.tar.gz
...
%prep
%setup -q -n python-ceilometerclient-1.0.14
