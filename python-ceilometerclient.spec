...
Version  : 2.0.0
Release  : 15
URL      : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-2.0.0.tar.gz
Source0  : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-2.0.0.tar.gz
...
%prep
%setup -q -n python-ceilometerclient-2.0.0
