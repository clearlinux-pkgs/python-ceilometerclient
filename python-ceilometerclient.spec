...
Version  : 2.1.0
Release  : 17
URL      : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-2.1.0.tar.gz
Source0  : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-2.1.0.tar.gz
...
%prep
%setup -q -n python-ceilometerclient-2.1.0
