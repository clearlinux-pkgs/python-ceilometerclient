...
Version  : 2.0.1
Release  : 16
URL      : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-2.0.1.tar.gz
Source0  : http://tarballs.openstack.org/python-ceilometerclient/python-ceilometerclient-2.0.1.tar.gz
...
%prep
%setup -q -n python-ceilometerclient-2.0.1
